...
public class AppleStockMaxProfit {

    public static int getMaxProfit(int[] stockPrices) {
        
        
        if (stockPrices.length < 2) {
            throw new IllegalArgumentException("There should be atleast 2 values in the StockPrices");
        }
    ...
    public static void main(String[] args) {
        Result result = JUnitCore.runClasses(AppleStockMaxProfit.class);
